...
export default function InviteEmployer({ cancelFunc, setInviteSent }) {
    ...
    return (
        <>
            ...
            <div className="fixed top-1/2 -translate-y-1/2 left-1/2 -translate-x-1/2 z-40 w-[90%] max-h-[90%] overflow-y-scroll scrollbar-none md:w-100 rounded-2xl bg-white shadow-md p-6">
                ...
                <form onSubmit={handleSubmit}>
                    ...
                    <button onClick={cancelFunc} className="cursor-pointer font-semibold block w-fit m-auto text-center mb-7">Cancel</button>
